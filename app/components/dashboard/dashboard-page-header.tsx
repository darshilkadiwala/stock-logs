...
export function DashboardPageHeader() {
  ...
  return (
    <PageHeader
      ...
      description={
        <ScrollArea
          className='h-auto w-full min-w-0 mask-[linear-gradient(to_right,transparent,black_2.5%,black_97.5%,transparent)] *:data-[slot="scroll-area-viewport"]:-mb-3 *:data-[slot="scroll-area-viewport"]:px-4 *:data-[slot="scroll-area-viewport"]:pb-3'
          type='always'>
